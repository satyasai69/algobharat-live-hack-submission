...
export declare class PendingGroup {
     ...
     *
     */
    addMethodCall<ArgsType, ReturnType>(params: Expand<MethodCallParams<ArgsType> & {
        isFirstTxn?: boolean;
    }>): void;
    addPayment(params: Expand<PaymentParams & {
        isFirstTxn?: boolean;
    }>): void;
    addAppCall(params: Expand<AppParams & {
        isFirstTxn?: boolean;
    }>): void;
    addAssetTransfer(params: Expand<AssetTransferParams & {
        isFirstTxn?: boolean;
    }>): void;
    addAssetCreation(params: Expand<AssetCreateParams & {
        isFirstTxn?: boolean;
    }>): void;
    addOnlineKeyRegistration(params: Expand<OnlineKeyRegParams & {
        isFirstTxn?: boolean;
    }>): void;
    addOfflineKeyRegistration(params: Expand<CommonTransactionParams & {
        isFirstTxn?: boolean;
    }>): void;
    addAssetConfig(params: Expand<AssetConfigParams & {
        isFirstTxn?: boolean;
    }>): void;
    addAssetFreeze(params: Expand<AssetFreezeParams & {
        isFirstTxn?: boolean;
    }>): void;
    submit(): void;
}
